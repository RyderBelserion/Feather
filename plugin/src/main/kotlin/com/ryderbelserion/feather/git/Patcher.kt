...
class Patcher {
    ...
    fun gitHistory(startHash: String, endHash: String): String {
        return shellRun("git", listOf("log", "$startHash..$endHash", "--format=format:%h %s"))
    }
    ...
    fun gitFormat(value: String, user: String, project: String, newLine: String): String {
        val hash = value.take(7)
        val msg = value.substring(8)
